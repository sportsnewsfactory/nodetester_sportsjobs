...
import { processSchedule } from '../functions/standalone/processSchedule';
    ...
    try {
        ...
        */
        ...
        if (subfolderStructure.length === 0) 
            throw `No subfolder structure found for product: ${edition.product_name}`;
        ...
        */
        ...
        let texts: AE.Json.TextImport[] = await processSchedule({DB, lang});
