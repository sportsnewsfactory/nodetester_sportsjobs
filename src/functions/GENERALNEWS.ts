...
export const GENERALNEWS = {
    ...
    async getTransItemsByLang(
        ...
        try {
            const sql = `
                SELECT rn.id, tr.file_name, tr.headline, tr.sub_headline, tr.narration, rn.sport_id, sports.name as sport_name, rn.background, rn.logo, rn.show_standings, rn.league_season_id, tr.lang
